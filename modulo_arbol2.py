...
def inorden_criaturas_derrotadas(arbol):
    if(arbol is not None):
        inorden_criaturas_derrotadas(arbol['izq'])
        if(arbol['datos']['derrotado_por']):
            print(arbol['info'], "fue derrotado por:", arbol['datos']['derrotado_por'])
        else:
            print(arbol['info'], "no fue derrotado")
            
        inorden_criaturas_derrotadas(arbol['der'])

def criaturas_que_aun_no_derrotaron(arbol):
    if(arbol is not None):
        criaturas_que_aun_no_derrotaron(arbol['izq'])
        if(arbol['datos']['derrotado_por'] is None):
            print(arbol['info'])
        criaturas_que_aun_no_derrotaron(arbol['der'])

def derrotados_por_Heracles(arbol):
    if(arbol is not None):
        derrotados_por_Heracles(arbol['izq'])
        if(arbol['datos']['derrotado_por'] == 'Heracles'):
            print(arbol['info'])
        derrotados_por_Heracles(arbol['der'])
